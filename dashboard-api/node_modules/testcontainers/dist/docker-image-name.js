...
class DockerImageName {
    ...
    isReaper() {
        return this.string === images_1.REAPER_IMAGE;
    }
    isHelperContainer() {
...
DockerImageName.HELPER_CONTAINERS = new Set([images_1.REAPER_IMAGE, images_1.SSHD_IMAGE]);
