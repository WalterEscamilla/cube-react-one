...
exports.connectNetwork = void 0;
const logger_1 = require("../../../logger");
const dockerode_1 = require("../../dockerode");
const connectNetwork = (options) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        logger_1.log.info(`Connecting container ${options.containerId} to network ${options.networkId}`);
        const network = dockerode_1.dockerode.getNetwork(options.networkId);
