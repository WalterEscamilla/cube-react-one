...
class LogWaitStrategy extends AbstractWaitStrategy {
    ...
    waitUntilReady(container) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const stream = yield container_logs_1.containerLogs(container);
...
class HealthCheckWaitStrategy extends AbstractWaitStrategy {
    waitUntilReady(container) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const retryStrategy = new retry_strategy_1.IntervalRetryStrategy(100);
            const status = yield retryStrategy.retryUntil(() => __awaiter(this, void 0, void 0, function* () { return (yield inspect_container_1.inspectContainer(container)).healthCheckStatus; }), (status) => status === "healthy" || status === "unhealthy", () => {
                const timeout = this.startupTimeout;
