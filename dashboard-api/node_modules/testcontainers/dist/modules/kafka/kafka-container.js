...
exports.StartedKafkaContainer = exports.KafkaContainer = exports.ZK_IMAGE = exports.KAFKA_IMAGE = void 0;
...
const port_generator_1 = require("../../port-generator");
...
exports.ZK_IMAGE = "confluentinc/cp-zookeeper:5.5.4";
class KafkaContainer extends generic_container_1.GenericContainer {
    constructor(image = exports.KAFKA_IMAGE, host, zooKeeperImage = exports.ZK_IMAGE) {
        super(image);
        this.zooKeeperImage = zooKeeperImage;
        this.uuid = new uuid_1.RandomUuid();
        this.portGenerator = new port_generator_1.RandomUniquePortGenerator();
    ...
    preCreate(boundPorts) {
        return __awaiter(this, void 0, void 0, function* () {
            const kafkaInternalPort = boundPorts.getBinding(KAFKA_PORT);
            this.withEnv("KAFKA_ADVERTISED_LISTENERS", `EXTERNAL_LISTENER://${yield docker_host_1.dockerHost}:${kafkaInternalPort},BROKER://${this.host}:${KAFKA_BROKER_PORT}`);
        });
    }
    start() {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (this.isZooKeeperProvided) {
                ...
                const zooKeeperPort = yield this.portGenerator.generatePort();
