...
exports.dockerComposeStop = void 0;
...
const dockerComposeStop = (options) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        yield docker_compose_1.stop(default_docker_compose_options_1.defaultDockerComposeOptions(options));
...
exports.dockerComposeStop = dockerComposeStop;
