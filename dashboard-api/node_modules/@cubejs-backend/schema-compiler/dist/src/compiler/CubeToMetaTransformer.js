    ...
    transform(cube, errorReporter) {
        ...
        return {
            config: {
                ...
                measures: ramda_1.default.compose(ramda_1.default.map((nameToMetric) => this.measureConfig(cube.name, cubeTitle, nameToMetric)), ramda_1.default.filter((nameToMetric) => this.isVisible(nameToMetric[1], true)), ramda_1.default.toPairs)(cube.measures || {}),
                ...
                })), ramda_1.default.filter(nameToDimension => this.isVisible(nameToDimension[1], !nameToDimension[1].primaryKey)), ramda_1.default.toPairs)(cube.dimensions || {}),
