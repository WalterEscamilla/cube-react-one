...
exports.normalizeQueryCancelPreAggregations = exports.normalizeQueryPreAggregationPreview = exports.normalizeQueryPreAggregations = exports.normalizeQuery = exports.getPivotQuery = exports.getQueryGranularity = exports.QUERY_TYPE = void 0;
...
const normalizeQueryPreAggregationPreview = (query) => {
    const { error } = joi_1.default.validate(query, queryPreAggregationPreviewSchema);
    if (error) {
        throw new UserError_1.UserError(`Invalid query format: ${error.message || error.toString()}`);
    }
    return query;
...
const normalizeQueryCancelPreAggregations = query => {
    const { error } = joi_1.default.validate(query, queryCancelPreAggregationPreviewSchema);
    if (error) {
        throw new UserError_1.UserError(`Invalid query format: ${error.message || error.toString()}`);
    }
    return query;
