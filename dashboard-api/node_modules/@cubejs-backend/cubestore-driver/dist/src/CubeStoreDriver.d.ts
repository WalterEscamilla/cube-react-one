import { BaseDriver, DriverInterface, IndexesSQL } from '@cubejs-backend/query-orchestrator';
...
export declare class CubeStoreDriver extends BaseDriver implements DriverInterface {
    ...
    uploadTableWithIndexes(table: string, columns: Column[], tableData: any, indexesSql: IndexesSQL): Promise<void>;
    private importRows;
